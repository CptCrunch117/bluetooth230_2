...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //find and set up thr ListView for paired devices
        ...
        //Register for broadcasts hen discovery has finished
        ...
        //If there are paired devices, add each one to the ArrayAdaoter
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(BluetoothDevice.ACTION_FOUND.equals(action)){
                ...
                //If it's alreadt paired, skip it, because it's been listed already
